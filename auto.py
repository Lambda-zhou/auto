...
def mainWork(img):
    ...
    while i < sheet1.nrows:
        ...
        if cmdType.value == 1.0:
            ...
            mouseClick(1, "left", os.path.join('img', img), reTry)
            print("单击左键", img)
        # 2代表双击左键
            ...
            if sheet1.row(i)[2].ctype == 2 and sheet1.row(i)[2].value != 0:
                reTry = sheet1.row(i)[2].value
            mouseClick(2, "left", os.path.join('img', img), reTry)
            print("双击左键", img)
        # 3代表右键
            ...
            if sheet1.row(i)[2].ctype == 2 and sheet1.row(i)[2].value != 0:
                reTry = sheet1.row(i)[2].value
            mouseClick(1, "right", os.path.join('img', img), reTry)
            print("右键", img)
            # 4代表输入
